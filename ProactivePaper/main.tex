...
% TITLE AND AUTHORS
% ============================================================================
\title{A Responsive and Explainable Robotics Solution for Human-Centric Industry 5.0 Applications}
...
\begin{figure}[h!]
    ...
    \caption{System Initialization and Task Setup Workflow}
...
\begin{figure}[h!]
    ...
    \caption{Example of Intention Monitoring for a task involving weighing of resin and hardener bottles in composite manufacturing}
    \label{fig:intent}
\end{figure}
...
\begin{figure}[h!]
    ...
    \caption{Example of output of perception module for a task involving weighing of resin and hardener bottles in composite manufacturing}
...
\begin{figure}[h!]
    ...
    \caption{Example of output of the affordance and performance module for a task involving weighing of resin and hardener bottles in composite manufacturing}
